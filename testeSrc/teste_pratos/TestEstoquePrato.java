...
import estoque.EstoqueDePratos;
...
public class TestEstoquePrato {
	...
	public void testPasso3() throws Exception {
		...
		Assert.assertEquals(34.26, pratoCircular.calculaPrecoTotal(), 0.01);
		Assert.assertEquals(12.0, pratoRetangular.calculaPrecoTotal(), 0.01);
		Assert.assertEquals(12.7, pratoTriangular.calculaPrecoTotal(), 0.01);
		Assert.assertEquals(58.96, estoque.totalDinheiroEstoque(), 0.01);
	}
	...
	public void testPasso4() throws Exception {
		...
		Assert.assertEquals(3, estoque.quantidadePratos());
		...
		Assert.assertEquals(1, estoque.quantidadePratos());
	...
	public void testPasso5e6() throws Exception {
		...
		Assert.assertEquals(3, estoque.quantidadePratos(), 0.01);

		List<PratoPersonalizado> pratos = estoque.getPratosOrdenadosPorPreco();

		Assert.assertEquals(12.0, pratos.get(0).calculaPrecoTotal(), 0.01);
		Assert.assertEquals(12.7, pratos.get(1).calculaPrecoTotal(), 0.01);
		Assert.assertEquals(34.26, pratos.get(2).calculaPrecoTotal(), 0.01);
	}
